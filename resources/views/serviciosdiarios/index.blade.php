                            ...
                            @foreach ($serviciosdiariosI as $serviciodiario)
                                <tr>
                                    ...
                                    <td class="border border-gray-400 px-4 py-2">
                                        ...
                                        <!-- Modal toggle -->
                                        <button
                                        data-modal-target="eliminar-serviciodiario-modal-{{ $serviciodiario->id }}"
                                        data-modal-toggle="eliminar-serviciodiario-modal-{{ $serviciodiario->id }}"
                                    ...
                                    <!-- Main modal -->
                                    <div id="eliminar-serviciodiario-modal-{{ $serviciodiario->id }}" tabindex="-1"
                                        aria-hidden="true"
                                        class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                        <div class="relative w-full max-w-md max-h-full">
                                            <!-- Modal content -->
                                            <div
                                                ...
                                                <button type="button"
                                                    class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                                                    data-modal-hide="eliminar-serviciodiario-modal-{{ $serviciodiario->id }}">
                                                ...
                                                <div class="px-6 py-6 lg:px-8">
                                                    <h3
                                                        class="mb-4 text-xl font-medium text-gray-900 dark:text-white">
                                                        ¿Desea Eliminar el Servicio con Código
                                                        '{{ $serviciodiario->id }}'?
                                                    </h3>
                                                    <form action="/serviciosdiarios/{{ $serviciodiario->id }}"
                                                        method="POST" class="space-y-6">
                                                        @csrf
                                                        @method('DELETE')
                                                        <div class="text-center">
