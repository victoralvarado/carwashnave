                                    ...
                                    <tr>
                                        @if ($usuario->id != 1)
                                            ...
                                            <td class="border border-gray-400 px-4 py-2">
                                                ...
                                                <!-- Modal toggle -->
                                                <button data-modal-target="eliminar-usuario-modal-{{ $usuario->id }}"
                                                    data-modal-toggle="eliminar-usuario-modal-{{ $usuario->id }}"
                                                ...
                                                <!-- Main modal -->
                                                <div id="eliminar-usuario-modal-{{ $usuario->id }}" tabindex="-1"
                                                    aria-hidden="true"
                                                    class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                    <div class="relative w-full max-w-md max-h-full">
                                                        <!-- Modal content -->
                                                        <div
                                                            ...
                                                            <button type="button"
                                                                class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                                                                data-modal-hide="eliminar-usuario-modal-{{ $usuario->id }}">
                                                                <svg aria-hidden="true" class="w-5 h-5"
                                                                    fill="currentColor" viewBox="0 0 20 20"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <path fill-rule="evenodd"
                                ...
                                @foreach ($servicios as $servicio)
                                    <tr>
                                        ...
                                        <td class="border border-gray-400 px-4 py-2">
                                            ...
                                            <!-- Condicion para mostrar a los id de servicios mayores o iguales a 4 -->
                                            @if ($servicio->id >= 4)
                                                <!-- Modal toggle -->
                                                <button
                                                    data-modal-target="eliminar-servicio-modal-{{ $servicio->id }}"
                                                    data-modal-toggle="eliminar-servicio-modal-{{ $servicio->id }}"
                                                    class="shadow my-1 bg-red-500 hover:bg-red-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded"
                                                    type="button">
                                                    Eliminar
                                                </button>
                                                ...
                                                <!-- Main modal -->
                                                <div id="eliminar-servicio-modal-{{ $servicio->id }}" tabindex="-1"
                                                    aria-hidden="true"
                                                    class="fixed top-0 left-0 right-0 z-50 hidden w-full p-4 overflow-x-hidden overflow-y-auto md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                                    <div class="relative w-full max-w-md max-h-full">
                                                        <!-- Modal content -->
                                                        <div
                                                            ...
                                                            <button type="button"
                                                                class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white"
                                                                data-modal-hide="eliminar-servicio-modal-{{ $servicio->id }}">
                                                                <svg aria-hidden="true" class="w-5 h-5"
                                                                    fill="currentColor" viewBox="0 0 20 20"
                                                                    xmlns="http://www.w3.org/2000/svg">
                                                                    <path fill-rule="evenodd"
                                                            ...
                                                            <div class="px-6 py-6 lg:px-8">
                                                                <h3
                                                                    ...
                                                                    '{{ $servicio->descripcion_servicio }}' con Código
                                                                    '{{ $servicio->id }}'?
                                                                </h3>
                                                                <form action="/servicios/{{ $servicio->id }}"
                                                                    method="POST" class="space-y-6">
